      ...
      <Stack className="product-detail-box" flexDirection="row">
        ...
        <Stack className="product-details-wrapper">
          <Stack className="detail-desc">
            <Box className="product-name">iPhone 17 Pro Max</Box>
            ...
            >
              ...
              <Box className="detail-collection-text">PHONE</Box>
            </Stack>

            <Stack className="price-desc">
              <Box className="detail-price">$192</Box>
              <Box className="detail-des">
                Introducing iPhone 17 Pro and iPhone 17 Pro Max, designed from
                the inside out to be the most powerful
              </Box>
            </Stack>
